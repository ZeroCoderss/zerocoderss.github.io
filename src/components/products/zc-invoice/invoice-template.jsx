...
const Controls = () => {
  ...
  return (
    <div className="flex mb-3 z-20 absolute bottom-4 right-6">
      <button
...
export default function InvoiceTemplate({ targetRef, invoiceData }) {
  ...
  return (
    <div className="container mx-auto p-4 h-[88vh] overflow-scroll bg-gray-50 rounded-sm">
      <TransformWrapper
        initialScale={1}
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-semibold">Due Date: {invoiceData.dueDate}</p>
                  </div>
                </div>
